...
工作项报告：`../../docs/p1-spatial-gain.md`。参考文献：`../../references/bibliography.md` 的 P1SG-R1..R3。
...
# 合成 (150 MC, 约 7 min)
cd reverse_verify/synthetic && python3 synth_gain.py --nproc 12

# 真实数据 (49 帧)
cd ../experiments/p1_spatial_gain/src
