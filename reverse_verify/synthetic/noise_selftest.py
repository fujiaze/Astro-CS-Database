...
跑法
----
    python3 reverse_verify/synthetic/noise_selftest.py                 # 全量
    python3 reverse_verify/synthetic/noise_selftest.py --quick         # 快速
    python3 reverse_verify/synthetic/noise_selftest.py --json OUT.json
"""
