// cli/v6_runtime_contract.h — RUNTIME-CI-001 (Wave 9) 运行面单一事实源
//
...
//   * 数值阈值不在此发明：门限常量权威在 cli/resource_gate.h（§18.2 冻结 85%/60%），
...
//   * 历史复现开关 --strict-resource-gate 仍在 cli/commands.cpp（旧测试断言 rc=10 用），
...
// 阈值越线的判定表达式由调用方（cli/resource_gate.h）给出，这里只做策略收口。
