...
复跑（推荐先设 TMPDIR 到 /dev/shm）::
    ...
    python3 实验/shared/data/synthetic/generate.py            # 全部
...
默认值由场景 JSON（`实验/shared/synthetic/scenes/m16_*.json` 的 `stack_n`）
...
SHARED = HERE.parents[2]                 # 实验/shared/  (data/synthetic/generate.py)
ROOT = HERE.parents[4]                   # 仓库根（实验/shared/data/synthetic -> 根）
