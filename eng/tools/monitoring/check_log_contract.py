#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""LOG-001 结构化日志合同机器检查器（eng/tools/monitoring 域，owner SA-LOG-08）。
...
用法：
  ...
  python3 eng/tools/monitoring/check_log_contract.py --jsonl <file> [--verify-redact]
  python3 eng/tools/monitoring/check_log_contract.py --stdin
