...
用法:
  python3 eng/tools/docs_machine_consistency.py [--root <repo>] [--json-out <file>] [--quiet]
  python3 eng/tools/docs_machine_consistency.py --self-test
  python3 eng/tools/docs_machine_consistency.py --fault-inject <name> [--root <repo>]
...
BENIGN_SURFACES = [
    ...
    (re.compile(r"^eng/tools/quality/frame_qc_grid\.py$"),
    ...
    (re.compile(r"^eng/tests/api/|^eng/tests/backend/|^eng/tests/cpu/"),
