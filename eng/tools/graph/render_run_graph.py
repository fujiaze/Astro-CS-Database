#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""LOG-003 运行图渲染工具（eng/tools/graph 域，owner SA-LOG-08）。
...
用法：
  python3 eng/tools/graph/render_run_graph.py --trace <run-trace.jsonl> \
      [--plan <plan.json>] [--out-dir <dir>] [--sha <40hex>] [--svg] [--name <stem>]
  python3 eng/tools/graph/render_run_graph.py --verify <graph.json> --trace <jsonl>
  python3 eng/tools/graph/render_run_graph.py --selfcheck
