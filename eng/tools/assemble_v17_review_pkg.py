...
EXACT_COMMANDS = [
    ...
    ("12", "py -3.12 eng/tools/phase1_e2e_bench.py --configs stage1_1727_*.json --name after_full_warm --warm 1"),
    ...
    ("15", "py -3.12 eng/tools/gen_repo_source_manifest.py"),
]
...
验证：
  py -3.12 eng/tools/verify_archive.py <解压目录>
"""
