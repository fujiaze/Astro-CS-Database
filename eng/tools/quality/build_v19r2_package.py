...
def main() -> int:
    ...
    cmds = [
        ...
        ["py -3.12", "eng/tools/quality/check_source_inventory.py"],
        ["py -3.12", "eng/tools/quality/check_comment_hygiene.py"],
        ["py -3.12", "eng/tools/quality/check_traceability.py"],
        ["py -3.12", "eng/tools/docs_machine_consistency.py"],
