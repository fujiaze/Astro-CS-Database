...
用法:
  python3 eng/tools/quality/check_commits_csv.py --repo ROOT --commits COMMITS.csv --results-dir evidence/v6_1_rework/tasks
  python3 eng/tools/quality/check_commits_csv.py --selftest
"""
...
def _selftest(repo: Path) -> int:
    ...
    gen = (repo / "eng" / "tools" / "quality" / "gen_commits_csv.py").resolve()
