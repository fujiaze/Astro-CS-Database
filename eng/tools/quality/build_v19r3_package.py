...
def _legacy_main() -> int:
    ...
    write("evidence/exact_commands.csv", (
        ...
        "s7,py -3.12 eng/tools/quality/v19r3_static.py --timeout 600 --parallel 8\n"
        "s8,wsl bash eng/tools/quality/v19r3_sanitizer.sh (ASan+UBSan 9/9)\n"
        "s9,py -3.12 eng/tools/quality/v19r3_traceability.py\n"
        "s9,py -3.12 eng/tools/docs_machine_consistency.py\n"
        "s10,py -3.12 eng/tools/quality/v19r3_strip_comments.py && v19r3_audit.py\n"
