...
用法:
  python3 eng/tools/quality/check_pipeline_graph.py --ir ir.json --module-index mods.json --trace trace.json
  python3 eng/tools/quality/check_pipeline_graph.py --selftest
"""
