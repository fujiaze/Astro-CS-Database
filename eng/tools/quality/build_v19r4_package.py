...
RETIRED_NOTICE = (
    ...
    "不是从门输出读来的 ⇒ 再跑一次就产出假绿。\n"
    "  活动替代: 无（V19 世代审阅包已作废）。\n"
    "  复原命令: git show 822b9c5391a14cc36979a7c550984f6ce363c713:eng/tools/quality/build_v19r4_package.py\n"
...
def _legacy_main() -> int:
    ...
    write("evidence/exact_commands.csv", (
        ...
        "verify,py -3.12 eng/tools/quality/v19r3_static.py (recheck)\n"
        "verify,wsl bash eng/tools/quality/v19r3_sanitizer.sh (9/9 PASS)\n"
        "verify,py -3.12 eng/tools/docs_machine_consistency.py (9/9)\n"))
...
""",
    ...
    p3_files = {
        "lib/infrastructure/acr/qualification/benchmarks/arithmetic_benchmark.cpp",
        "lib/infrastructure/acr/qualification/benchmarks/atomic_benchmark.cpp",
        "lib/infrastructure/acr/qualification/benchmarks/branch_benchmark.cpp",
        "lib/infrastructure/acr/qualification/benchmarks/convolution_benchmark.cpp",
        "lib/infrastructure/acr/qualification/benchmarks/irregular_benchmark.cpp",
        "lib/infrastructure/acr/qualification/benchmarks/numa_benchmark.cpp",
        "lib/infrastructure/acr/qualification/benchmarks/overhead_benchmark.cpp",
        "lib/infrastructure/acr/qualification/benchmarks/reduction_benchmark.cpp",
        "lib/infrastructure/acr/qualification/benchmarks/thread_curve_benchmark.cpp",
        ...
        "lib/infrastructure/hips_browser/healpix_browser_qt/app/browser_cli.cpp",
