...
"根 VERSION 唯一事实源/生成链禁止手抄" 合同一致):
  ...
  [4] CLI 版本定义点 (实际形态: 无手抄常量, 全部由生成链注入):
      ...
      d) **[W4-A3 退役] 原「cli/CMakeLists.txt 必须 file(READ ../VERSION)」与
         ...
         (常量锚 ROOT_CMAKE_REL + CLI_TEMPLATE_REL)，见 eng/ci/root_manifest.json。
...
# (chain_root_read_version :51 + chain_configure_file_root :62)，见 eng/ci/root_manifest.json。
