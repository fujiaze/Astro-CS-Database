#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""eng/ci/validate_candidate.py —— V8-CI-007 Windows candidate 包结构校验门禁。

用法：``python3 eng/ci/validate_candidate.py <candidate.zip> [--json]``

被校验对象是 ``eng/tools/quality/ci_windows_driver.py``（V8-CI-006）package
...
# ---- 排除规则（对齐 eng/tools/quality/ci_windows_driver.py EXCLUDE_*，自持副本）----
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        prog="eng/ci/validate_candidate.py",
