#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""eng/ci/verify_remote_run.py — V8-CI-012 F-D4：hosted run 机器复验（stdlib-only）。

复验派发单 ledger_command 语义：
  python3 eng/ci/verify_remote_run.py --sha <sha> --workflows <name>... \
...
Exit code（与 eng/ci/verify_actions_lock.py 同风格）：
...
def verify_all(args: argparse.Namespace) -> dict:
    ...
    return {"tool": "eng/ci/verify_remote_run.py", "utc": utc_iso(),
...
def build_parser() -> argparse.ArgumentParser:
    ap = _ArgParser(prog="eng/ci/verify_remote_run.py",
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.offline:
        ...
        report = {"tool": "eng/ci/verify_remote_run.py", "utc": utc_iso(),
    ...
    try:
        ...
        err = {"tool": "eng/ci/verify_remote_run.py", "utc": utc_iso(),
