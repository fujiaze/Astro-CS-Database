#!/usr/bin/env python3
"""IO-002 HiPS fixture 重建生成器 (eng/tests/io/make_hips_fixture.py)。
...
用法:
  python3 eng/tests/io/make_hips_fixture.py <out_dir> [--order K] [--seed N]
  python3 eng/tests/io/make_hips_fixture.py --rebuild <out_dir>   # 删除重建
...
def build_fixture(out_dir: pathlib.Path, order: int, seed: int,
    ...
    props = [
        ...
        ("hips_creator", "ACSD (make_hips_fixture)"),
