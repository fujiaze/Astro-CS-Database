 ...
 *
 * 对齐先例: eng/tests/unit/drizzle_adapter_test.cpp → #include drizzle_adapter_impl.cpp
 *           eng/tests/unit/gaia_adapter_test.c  → #include gaia_client.c
 * 本 TU 把 lib/algorithms/drizzle/hips/src/module_entry.cpp (astrocs_module_query_v1 唯一定义,
 ...
 */
#include "../../../../lib//algorithms/drizzle/hips/src/module_entry.cpp"
