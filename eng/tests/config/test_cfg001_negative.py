...
class TestNegativeFixturesMustFail(unittest.TestCase):
    def test_negative_01_unknown_filter_name(self):
        ...
        ok["blocks"][0]["filter_passband"] = "Baader R"   # 逐字命中 eng/packaging/config/filters.json
    ...
    def test_negative_02_missing_output_dir(self):
        errs = errors_for("eng/contracts/schemas/phase_config_normalize.schema.json",
    ...
    def test_run_manifest_rejects_hardware_field(self):
        errs = errors_for("eng/contracts/schemas/run_manifest.schema.json",
    ...
    def test_cpu_profile_v1_missing_required_still_fails(self):
        ...
        errs = errors_for("eng/contracts/schemas/cpu_profile.schema.json",
    ...
    def test_cpu_profile_v2_missing_writer_binding_fails(self):
        ...
        doc = C.load_json("eng/tests/config/fixtures/positive/cpu_profile_v2.json")
        del doc["build"]["provider_build_ids"]
        errs = C.validate(C.load_json("eng/contracts/schemas/cpu_profile.schema.json"), doc)
    ...
    def test_drizzle_pixfrac_domain_is_enforced(self):
        ...
        """
        schema = C.load_json("eng/contracts/schemas/phase_config_normalize.schema.json")
        tpl = C.load_json("eng/packaging/config/templates/normalize.phase_config.json")
        for field in ("algorithm_drizzle_pixfrac", "drizzle"):
            for bad in (0, 0.0, -0.1, 1.5):
                probe = C.load_json("eng/packaging/config/templates/normalize.phase_config.json")
                if field == "drizzle":
    ...
    def test_cpu_profile_kernel_defs_are_wired_and_enforced(self):
        ...
        schema = C.load_json("eng/contracts/schemas/cpu_profile.schema.json")
        ...
        v1 = C.load_json("eng/tests/config/fixtures/positive/cpu_profile_v1_legacy.json")
        ...
        v2 = C.load_json("eng/tests/config/fixtures/positive/cpu_profile_v2.json")
