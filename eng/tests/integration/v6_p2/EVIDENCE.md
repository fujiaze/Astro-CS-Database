...
- 写域：`lib/phase2_int/`、`eng/tests/integration/v6_p2/`（tracked 树零越界修改，见 §5）
...
| 集成测试配置 | `cmake -S eng/tests/integration/v6_p2 -B run/v6/P2-INTEGRATE-001/build_it -DCMAKE_BUILD_TYPE=Release` | 0 | `logs/03_configure_it.log` |
...
`git status --porcelain -- lib/phase2_int lib/algorithms/coverage eng/tests/integration/v6_p2` 仅显示两个新增目录；
...
1. **AR-033 构建面**：`astrocs_v6_phase2_integrate` 与 `eng/tests/integration/v6_p2` 未注册进根/公共
