...
SCHEMAS = REPO / "eng/contracts/schemas/v6"
...
class TestV6VocabularyAndMigration(unittest.TestCase):
    def setUp(self):
        self.v = _load(REPO / "eng/contracts/data/v6_weight_vocabulary_v1.json")
        self.m = _load(REPO / "eng/contracts/data/v6_migration_map_v1.json")
