...
| 文件 | 类型 | 说明 |
| --- | --- | --- |
| `工程控制/evidence/P13-001/scripts/stage1_batch_runner.py` | 新增 | Stage1 批处理 runner（710 帧，hash 缓存 + 断点 + 超时 + 分类报告） |
| `工程控制/evidence/P13-001/scripts/test_stage1_batch_runner.py` | 新增 | 自动测试（10 用例，795 断言） |
| `工程控制/evidence/P13-001/raw_logs/test_run_20260729_120344.log` | 新增 | 测试运行日志 |
