...
| 文档 | 路径 | 用途 |
| --- | --- | --- |
| 项目状态 | [工程控制/control/PROJECT_STATE.yaml](file:///f:/Astro%20dev/Astro%20CS%20Normalization%20Database/工程控制/control/PROJECT_STATE.yaml) | 当前项目状态 |
| 任务注册表 | [工程控制/control/MASTER_TASK_REGISTER.csv](file:///f:/Astro%20dev/Astro%20CS%20Normalization%20Database/工程控制/control/MASTER_TASK_REGISTER.csv) | 50 任务状态 |
| 当前任务 | [工程控制/control/CURRENT_TASK.md](file:///f:/Astro%20dev/Astro%20CS%20Normalization%20Database/工程控制/control/CURRENT_TASK.md) | 当前任务详情 |
| 基线事实 | [工程控制/control/BASELINE_FACTS.md](file:///f:/Astro%20dev/Astro%20CS%20Normalization%20Database/工程控制/control/BASELINE_FACTS.md) | 已冻结基线 |
| 决策登记 | [工程控制/control/DECISION_REGISTER.md](file:///f:/Astro%20dev/Astro%20CS%20Normalization%20Database/工程控制/control/DECISION_REGISTER.md) | 关键决策记录 |
| 风险登记 | [工程控制/control/RISK_REGISTER.csv](file:///f:/Astro%20dev/Astro%20CS%20Normalization%20Database/工程控制/control/RISK_REGISTER.csv) | 风险跟踪 |

### 5.2 P13-002 证据 4 件套

| 文档 | 路径 |
| --- | --- |
| 任务报告 | [工程控制/evidence/P13-002/TASK_REPORT.md](file:///f:/Astro%20dev/Astro%20CS%20Normalization%20Database/工程控制/evidence/P13-002/TASK_REPORT.md) |
| 测试报告 | [工程控制/evidence/P13-002/TEST_REPORT.md](file:///f:/Astro%20dev/Astro%20CS%20Normalization%20Database/工程控制/evidence/P13-002/TEST_REPORT.md) |
| 证据索引 | [工程控制/evidence/P13-002/EVIDENCE_INDEX.md](file:///f:/Astro%20dev/Astro%20CS%20Normalization%20Database/工程控制/evidence/P13-002/EVIDENCE_INDEX.md) |
| 独立复核 | [工程控制/evidence/P13-002/REVIEW_REPORT.md](file:///f:/Astro%20dev/Astro%20CS%20Normalization%20Database/工程控制/evidence/P13-002/REVIEW_REPORT.md) |

### 5.3 自治入口与规格

| 文档 | 路径 | 用途 |
| --- | --- | --- |
| 自治入口 | [工程控制/AUTONOMOUS_ENTRY.md](file:///f:/Astro%20dev/Astro%20CS%20Normalization%20Database/工程控制/AUTONOMOUS_ENTRY.md) | Agent 自治执行入口 |
| 阶段边界 | [工程控制/docs/00_PHASE_GOAL_AND_BOUNDARIES.md](file:///f:/Astro%20dev/Astro%20CS%20Normalization%20Database/工程控制/docs/00_PHASE_GOAL_AND_BOUNDARIES.md) | 阶段目标与边界 |
| Stage1 Spec | [工程控制/docs/08_STAGE1_REAL_DATA_FULL_VALIDATION_SPEC.md](file:///f:/Astro%20dev/Astro%20CS%20Normalization%20Database/工程控制/docs/08_STAGE1_REAL_DATA_FULL_VALIDATION_SPEC.md) | Stage1 全量验证规格 |
| 银心马赛克 Spec | [工程控制/docs/09_GALAXY_CENTER_THREE_PANEL_MOSAIC_SPEC.md](file:///f:/Astro%20dev/Astro%20CS%20Normalization%20Database/工程控制/docs/09_GALAXY_CENTER_THREE_PANEL_MOSAIC_SPEC.md) | 银心三片马赛克规格 |
