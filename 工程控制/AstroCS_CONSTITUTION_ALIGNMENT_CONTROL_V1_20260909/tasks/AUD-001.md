# AUD-001｜独立复核P0P1和发布门禁

## 目标
独立 SubAgent 复核：findings 登记册全部条目状态（fixed 须有修复 commit 证据/open 须有 owner 待裁）、P0/P1=0（或 owner defer 显式）、G-* 全链证据、L0 一致。

## 依赖
`ARCH-AUDIT-P1|DOC-001|BASE-UTIL-001|P1-HIPS-DIGEST-001`。BASE_SHA 取执行时最新 main（三 SHA 一致）。
