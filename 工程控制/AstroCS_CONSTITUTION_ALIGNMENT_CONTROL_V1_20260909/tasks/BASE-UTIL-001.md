# BASE-UTIL-001｜P2利用率低独立归因诊断

## 目标
用 BASE 主构建二进制复现 p2001/p2002/p2006 utilization_p75_low，按冻结宪章 §10.5 四类归因（NOT_APPLICABLE/ENV/MONITOR 错误/真实缺陷），逐项记录 CPU/affinity/workers/queue/progress/带宽/hash。
