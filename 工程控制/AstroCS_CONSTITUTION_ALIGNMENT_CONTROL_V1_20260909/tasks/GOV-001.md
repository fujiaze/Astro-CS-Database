# GOV-001｜负责人冻结宪章与四项裁决

## 目标
负责人直接提交 FROZEN 状态、四项明确值、supersession 与冲突消解；Worker/Agent 不得代写裁决。

## 依赖
`BASE-001`。执行时 BASE_SHA 必须为最新 main，若依赖提交后基线变化须重取。

## 写入白名单
- `ASTROCS_PROJECT_CONSTITUTION.md`
