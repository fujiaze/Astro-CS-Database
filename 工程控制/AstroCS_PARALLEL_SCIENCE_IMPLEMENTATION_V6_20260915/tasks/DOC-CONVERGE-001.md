...
同步最终 SCI/ALG/DATA/API/状态/文献和审核包，保留历史迁移说明。

## 调度合同

- depends_on: WIN-VERIFY-001
- wave: 12
- write_scope: docs/, README.md, REVIEW.md, CHANGELOG.md, reports/v6/release-review/, artifacts/v6/release-review/
