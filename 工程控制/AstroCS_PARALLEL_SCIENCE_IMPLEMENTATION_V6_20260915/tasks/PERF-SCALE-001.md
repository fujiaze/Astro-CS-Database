...
验证 1/4/16 worker、资源门、内存、determinism 与 heavy 路径利用率。

## 调度合同

- depends_on: RUNTIME-CI-001
- wave: 10
- write_scope: artifacts/v6/performance/, reports/v6/performance/, run/v6/performance/
