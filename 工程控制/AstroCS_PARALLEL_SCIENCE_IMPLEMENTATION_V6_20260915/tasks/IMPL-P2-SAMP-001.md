# IMPL-P2-SAMP-001 — Phase2 采样覆盖实现
...
实现空间模型求值、coverage/support 区分及确定性边界。

## 调度合同

- depends_on: CONTRACT-FREEZE-001
- wave: 5
- write_scope: lib/phase2/src/sampler.cpp, lib/phase2/src/coverage.cpp, lib/phase2/include/astro/phase2/sampler.h, lib/phase2/include/astro/phase2/coverage.h, lib/phase2_samp/, tests/unit/v6_p2_samp/
