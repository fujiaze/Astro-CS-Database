# IMPL-P1-CAL-001 — Phase1 校准 covariance 实现
...
实现 light/master/flat/Poisson/read noise 与共享 master covariance；不得接线 session。

## 调度合同

- depends_on: CONTRACT-FREEZE-001
- wave: 5
- write_scope: lib/calibration/, tests/unit/v6_p1_cal/
