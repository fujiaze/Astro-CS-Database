...
实现 overlap graph、gauge、乘法/加性模型、参数 covariance 与欠定失败。

## 调度合同

- depends_on: CONTRACT-FREEZE-001
- wave: 5
- write_scope: lib/phase2/src/upm.cpp, lib/phase2/include/astro/phase2/upm.h, lib/phase2_upm/, tests/unit/v6_p2_upm/
