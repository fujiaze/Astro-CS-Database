...
按宪章在 Fatduck 验证同 SHA 候选安装、ABI、长路径、>2GiB、真实产品；不得宣布发布。

## 调度合同

- depends_on: REAL-SCIENCE-001, PERF-SCALE-001
- wave: 11
- write_scope: artifacts/v6/windows/, reports/v6/windows/
