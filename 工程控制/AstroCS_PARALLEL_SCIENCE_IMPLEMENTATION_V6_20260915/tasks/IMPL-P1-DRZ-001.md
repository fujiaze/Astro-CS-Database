# IMPL-P1-DRZ-001 — Phase1 Drizzle correlation 实现
...
实现 signal 单位、球面 overlap、variance/correlation 传播；不接线 session。

## 调度合同

- depends_on: CONTRACT-FREEZE-001
- wave: 5
- write_scope: lib/healpix_db/, tests/unit/v6_p1_drz/
