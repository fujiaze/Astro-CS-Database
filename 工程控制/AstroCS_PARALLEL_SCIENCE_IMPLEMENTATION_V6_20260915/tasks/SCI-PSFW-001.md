# SCI-PSFW-001 — PSF Signal Weight 冻结研究
...
复核 W_info、PixInsight-style PSFSW、PSF SNR power ratio、共同星集和 selection bias；给出冻结建议。

## 调度合同

- depends_on: BASE-OWN-001
- wave: 1
- write_scope: docs/science/v6/psfw/, run/v6/sci-psfw/
