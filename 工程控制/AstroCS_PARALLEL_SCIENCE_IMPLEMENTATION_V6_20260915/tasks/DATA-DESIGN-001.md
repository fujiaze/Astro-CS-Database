# DATA-DESIGN-001 — 跨 Phase schema 设计
...
设计 signal/covariance/PSF/W_info/PSFSW components/weight_mode/effective PSF/provenance schema。

## 调度合同

- depends_on: SCI-ADJ-001
- wave: 3
- write_scope: docs/contracts/v6/data/, contracts/proposals/v6/data/
