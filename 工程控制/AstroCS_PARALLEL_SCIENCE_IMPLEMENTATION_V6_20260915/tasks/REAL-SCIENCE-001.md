# REAL-SCIENCE-001 — Linux 真实数据科学验收
...
在 M42/银心/全部适用数据比较等权、exposure、ivar、W_info、PSFSW，报告科学和资源指标。

## 调度合同

- depends_on: RUNTIME-CI-001
- wave: 10
- write_scope: artifacts/v6/real-science/, reports/v6/real-science/, run/v6/real-science/
