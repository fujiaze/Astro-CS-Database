...
用法：
  python3 tools/check_l0_docs.py [--root <repo>] [--json-out <file>] [--strict]
  python3 tools/check_l0_docs.py --self-test     # 可执行负例面（tempfile mini-repo）
