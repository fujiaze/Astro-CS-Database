...
用法：
  python3 tools/quality/sweep_test_tmp.py                  # 干跑，只报告
  python3 tools/quality/sweep_test_tmp.py --apply          # 真删
  python3 tools/quality/sweep_test_tmp.py --apply --min-age 2   # 只删 2 分钟前的（默认 5）
  python3 tools/quality/sweep_test_tmp.py --roots /dev/shm /tmp /var/tmp/astrocs
"""
