...
用法：
  python3 tools/quality/check_secret_hygiene.py                       # 默认 scope=pack
  python3 tools/quality/check_secret_hygiene.py --scope tracked
  python3 tools/quality/check_secret_hygiene.py --scope walk --root <dir>
  python3 tools/quality/check_secret_hygiene.py --files a.md b.md --report-only
...
DEFAULT_PACKER = REPO / "tools" / "pack_audit_package.py"
