#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""tools/quality/compare_products.py — 产物确定性比对口径（P26 T3；负责人裁决 4）。
...
用法:
  python3 tools/quality/compare_products.py --a RUN1 --b RUN2 [--out DIR]
  python3 tools/quality/compare_products.py --a R1 --b R2 --tolerance 1e-5
  python3 tools/quality/compare_products.py --list-ignored
...
def compare_trees(a, b, rel_tol=0.0, abs_tol=0.0, extra_ignore=()):
    ...
    report = {
        ...
        "tool": "tools/quality/compare_products.py",
