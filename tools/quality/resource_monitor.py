#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""tools/quality/resource_monitor.py — 外挂资源监控（P26 T1；纯 stdlib，Linux /proc）。
...
用法:
  python3 tools/quality/resource_monitor.py --out run/resource/mon -- <cmd> [args...]
  python3 tools/quality/resource_monitor.py --out DIR --pid <pid> [--duration 30]
  python3 tools/quality/resource_monitor.py --judge --out DIR -- <cmd> [args...]
  python3 tools/quality/resource_monitor.py --judge --from DIR
...
def main(argv=None):
    ...
    summ.update({
        ...
        "tool": "tools/quality/resource_monitor.py",
