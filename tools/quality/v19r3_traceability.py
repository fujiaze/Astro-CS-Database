...
CONTRACTS = [
    ...
    ("DATA-UPM-CONTROL-UNC-001",
     ...
     "docs/science/PHASE2_UPM.md", "phase2",
     "lib/algorithms/coverage/src/sampler.cpp;lib/algorithms/coverage/tools/stage2.cpp",
    ...
    ("DATA-UPM-MODEL-001",
     ...
     "lib/algorithms/coverage/src/upm.cpp;lib/infrastructure/aio/src/aio_upm.cpp",
    ...
    ("ENG-ERR-001",
     ...
     "lib/algorithms/coverage/src/upm.cpp;lib/algorithms/coverage/src/integrate.cpp",
