...
用法
  python3 ci/check_no_weight_mode.py                 # 扫真实仓库，rc=0 全绿
  python3 ci/check_no_weight_mode.py --json-out F    # 机器可读结果（原子写）
  python3 ci/check_no_weight_mode.py --self-test     # 临时目录正例/负例，证明能红能绿
