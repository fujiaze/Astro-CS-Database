...
--fault-inject），仅有人工说明不算」。本 harness 对 ci/checks.json 的每一个注册项
给出一条机器可执行的极性记录：
...
用法:
  python3 ci/polarity_probe.py --plan          打印全表 + 覆盖统计（不执行）
  python3 ci/polarity_probe.py --check         断言"每个注册项都有极性记录"
  python3 ci/polarity_probe.py --run-provable  跑 auto=True 的条目并刷新 ledger
  python3 ci/polarity_probe.py --gate <ID>     只跑一门
...
LEDGER = REPO / "ci" / "polarity_evidence.json"
...
g("CHK-DANGLING", "PROVEN-EXECUTABLE", "P1",
  (_p("tools/doccheck/check_doc_index.py", "--strict"), 0, "repo"),
  (_p("tools/doccheck/check_doc_index.py", "--self-test"), 0, "repo"),
  "selftest(9 例：锚缺失/旧权威回归/覆盖缺口/空树/--root 不存在)",
  "run/PROJECT-GOVERNANCE-01/CI-003/logs/", auto=True)
g("DOC-L0", "RE-JUDGED", "P1",
  (_p("tools/check_l0_docs.py"), 0, "repo"),
  (_p("tools/check_l0_docs.py", "--self-test"), 0, "repo"),
  "selftest(8 例：缺文档/索引未登记/根索引复活/旧权威重主张/strict 升级)",
  "run/PROJECT-GOVERNANCE-01/CI-003/logs/", auto=True)
g("VERSION-CONSISTENCY", "RE-JUDGED", "P1",
  (_p("ci/check_version.py", "--expected", "0.11.0-alpha.2"), 0, "repo"),
  (_p("ci/check_version.py", "--self-test"), 0, "repo"),
...
g("AGENTS-GOV", "RE-JUDGED", "P0",
  (_p("tools/check_agents_gov.py"), 0, "repo"),
  (_p("tools/check_agents_gov.py", "--self-test"), 0, "repo"),
...
g("ENG-CONSTRAINTS", "RE-JUDGED", "P0",
  (_p("tools/doccheck/check_engineering_constraints.py"), 0, "repo"),
  (_p("tools/doccheck/check_engineering_constraints.py", "--self-test"), 0, "repo"),
...
g("CHK-REGISTRY-DOC-SYNC", "PROVEN-EXECUTABLE", "P0",
  (_p("ci/check_registry_doc_sync.py"), 0, "repo"),
  (_p("ci/check_registry_doc_sync.py", "--self-test"), 0, "repo"),
...
g("RESOURCE-GATE-REAL", "PROVEN-EXECUTABLE", "P0",
  (_p("tools/quality/check_resource_gate_real.py", "--fault-inject", "busy", "--seconds", "20"), 0, "repo"),
  (_p("tools/quality/check_resource_gate_real.py", "--fault-inject", "serial", "--seconds", "20"), 0, "repo"),
...
g("RESOURCE-GATE-REAL-NEG", "PROVEN-EXECUTABLE", "P0",
  (_p("tools/quality/check_resource_gate_real.py", "--fault-inject", "serial", "--seconds", "0"), 1, "repo"),
  (_p("tools/quality/check_resource_gate_real.py", "--fault-inject", "serial", "--seconds", "20"), 0, "repo"),
...
for gate, grade, pos, neg, kind, ev in [
    ("CHK-MODULE-MANIFEST", "P0", _p("tools/quality/check_module_map.py", "--selftest"),
     _p("tools/quality/check_module_map.py", "--repo-root", EMPTY, "--quiet"),
    ...
    ("CHK-ROOT-CLEAN", "P0", _p("-m", "pytest", "tests/quality/test_root_cleanliness.py", "-q"),
     _p("tools/quality/check_root_cleanliness.py", "--root", EMPTY,
    ...
    ("API-DOCS", "P0", _p("-m", "pytest", "tests/quality/test_doc_machine_check.py", "-q"),
     _p("tools/check_api_docs.py", "--repo", EMPTY), "unittest-suite + mutation",
     "run/PROJECT-GOVERNANCE-01/CI-001/evidence/"),
    ("CHK-SCHEMA", "P0", _p("tools/monitoring/check_log_contract.py", "--selfcheck"),
     _p("tools/quality/check_task_result_schema.py", "--results-dir", EMPTY),
     "selftest + missing-dependency", "run/PROJECT-GOVERNANCE-01/CI-001/evidence/"),
    ("CHK-STATIC", "P1", _p("tools/quality/check_prod_reachability.py", "--selftest"),
     _p("tools/quality/check_complexity.py", "--paths", EMPTY + ",x", "--output", "run/ci/cx.json"),
     "selftest + missing-dependency", "run/PROJECT-GOVERNANCE-01/CI-001/evidence/"),
]:
...
for gate, grade, kind in [
    ...
    g(gate, "PROVEN-EXECUTABLE", grade, (_p("-m", "pytest", "tests/quality", "-q"), 0, "repo"),
      (_p("tools/quality/check_prod_reachability.py", "--selftest"), 0, "repo"), kind,
...
FACE = {
 ...
 "CHK-PACKAGE": ("P0", "候选注入哈希不符 ⇒ ci/validate_candidate.py 必须非 0", "需 Windows 平台"),
 ...
 "LINUX-MAIN-FIXTURES": ("P0", "wf_step.py --step LINUX-PREPARE-FIXTURES 缺夹具树 ⇒ 必须非 0",
                         "wf_step 绑定面（ci/workflow_binding.json）"),
...
def build_ledger():
    reg = json.loads((REPO / "ci" / "checks.json").read_text(encoding="utf-8"))["checks"]
    ...
    doc = {
        "schema_version": 2,
        "task": "CI-003",
        "generated_by": "ci/polarity_probe.py",
        "definition": {
