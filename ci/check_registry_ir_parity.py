...
锚点（硬编码引用，缺失即 rc=2 并点名 ANCHOR_MISSING）：
  ...
  - ci/ledgers/registry_ir_parity.json（显式台账：已知差异 + 理由/负责人/解除条件）

用法：
  python3 ci/check_registry_ir_parity.py [--repo ROOT] [--json-out F] [--self-test]
...
LEDGER = "ci/ledgers/registry_ir_parity.json"
