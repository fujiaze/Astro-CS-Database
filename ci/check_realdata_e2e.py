...
用法：
  python3 ci/check_realdata_e2e.py --plan
  python3 ci/check_realdata_e2e.py --execute [--work-dir DIR]
  python3 ci/check_realdata_e2e.py --verify-only [--work-dir DIR]
  python3 ci/check_realdata_e2e.py --self-test
