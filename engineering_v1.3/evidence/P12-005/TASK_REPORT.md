...
- **修复位置**: `engineering_v1.3/evidence/P12-004/scripts/run_photometric_matrix.py`
- **修复内容**:
...
| 文件 | 修改内容 |
| --- | --- |
| `engineering_v1.3/evidence/P12-004/scripts/run_photometric_matrix.py` | SCALE_FACTOR_MIN=0.0；新增 DEVICE_CALIB_DIR 配置；T2 改用 ASCII junction 路径 |
| `engineering_v1.3/evidence/P12-004/scripts/stage1_config_T2.json` | 新增 T2 设备 config (calibration_dir=T2 calibration files) |
| `engineering_v1.3/evidence/P12-004/scripts/stage1_config_T3.json` | 新增 T3 设备 config |
| `engineering_v1.3/evidence/P12-004/scripts/stage1_config_T4.json` | 新增 T4 设备 config |
