...
- `engineering_v1.3/evidence/P12-003/TASK_REPORT.md`
- `engineering_v1.3/evidence/P12-003/TEST_REPORT.md`
- `engineering_v1.3/evidence/P12-003/EVIDENCE_INDEX.md` (本文件)
- `engineering_v1.3/evidence/P12-003/REVIEW_REPORT.md`

### 3.2 测试产物（已存在，本次任务引用）

- `engineering_v1.3/evidence/P12-003/reports/test_results.json`
- `engineering_v1.3/evidence/P12-003/reports/filter_qe_provenance.json`
- `engineering_v1.3/evidence/P12-003/raw_logs/test_spectrum_integrator_golden.log`
