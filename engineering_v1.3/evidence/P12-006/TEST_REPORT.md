...
| 项 | 值 |
| --- | --- |
| 脚本路径 | `engineering_v1.3/evidence/P12-006/scripts/generate_formal_hiss.py` |
| 脚本退出码 | 0 (成功) |
| 总耗时 | 0.11 秒 (复制 + inspect + 哈希 + 清单生成) |
| 日志路径 | `engineering_v1.3/evidence/P12-006/raw_logs/generate_formal_hiss.log` |
| 源 HISS 路径 | `engineering_v1.3/evidence/P12-004/raw_logs/<frame>/<frame>.hiss` |
| 正式 HISS 路径 | `engineering_v1.3/evidence/P12-006/hiss/<frame>.hiss` |
