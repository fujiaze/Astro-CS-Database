...
P12-005 已通过 orchestrator stage1 完整流水线为 16 帧代表帧生成 HISS 文件（含 has_snr=1, n_points>0），全部存储在 `engineering_v1.3/evidence/P12-004/raw_logs/<frame>/`。stage1 流水线所有必需阶段（CALIBRATE、PLATESOLVE、PSF、PHOTOMETRIC、SNR、DRIZZLE、HISS）完整运行，无 skip。

P12-006 任务将这些 HISS 文件复制到正式位置 `engineering_v1.3/evidence/P12-006/hiss/`，并独立 inspect 每个 HISS 文件。
...
| 文件 | 类型 | 说明 |
| --- | --- | --- |
| `engineering_v1.3/evidence/P12-006/scripts/generate_formal_hiss.py` | Python 脚本 | HISS 复制 + inspect + 哈希 + 清单生成 |
| `engineering_v1.3/evidence/P12-006/hiss/*.hiss` (16 份) | 二进制 | 正式 HISS 文件 |
| `engineering_v1.3/evidence/P12-006/reports/hiss_inventory.csv` | CSV | HISS 清单 |
| `engineering_v1.3/evidence/P12-006/reports/hiss_generation_summary.json` | JSON | 摘要 |
| `engineering_v1.3/evidence/P12-006/raw_logs/generate_formal_hiss.log` | 日志 | 脚本运行日志 |
| `engineering_v1.3/evidence/P12-006/TASK_REPORT.md` | 报告 | 本文件 |
| `engineering_v1.3/evidence/P12-006/TEST_REPORT.md` | 报告 | 测试报告 |
| `engineering_v1.3/evidence/P12-006/EVIDENCE_INDEX.md` | 报告 | 证据索引 |
| `engineering_v1.3/evidence/P12-006/REVIEW_REPORT.md` | 报告 | 独立复核 |
