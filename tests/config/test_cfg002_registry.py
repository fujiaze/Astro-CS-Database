...
class TestCfg002Registry(unittest.TestCase):
    ...
    def test_os_abi_negative_fixture_rejected_by_enum(self):
        ...
        pos = C.load_json("tests/config/fixtures/positive/cpu_profile_v2.json")
    ...
    def test_filter_name_rule_is_frozen_with_no_alias(self):
        ...
        look = C.load_json("config/filters.json")["lookup"]
    ...
    def test_registry_pointer_is_declared_from_defaults(self):
        ...
        ref = C.load_json("config/defaults.json")["registry_ref"]
        self.assertEqual("config/config_registry.json", ref["path"])
