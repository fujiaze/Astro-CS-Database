...
PSFSW = "contracts/schemas/v6/astrocs.v6.psfsw.v1.schema.json"
WEIGHTMODE = "contracts/schemas/v6/astrocs.v6.weight-mode.v1.schema.json"
PROVENANCE = "contracts/schemas/v6/astrocs.v6.provenance.v1.schema.json"
COVARIANCE = "contracts/schemas/v6/astrocs.v6.covariance.v1.schema.json"
SIGNAL = "contracts/schemas/v6/astrocs.v6.signal.v1.schema.json"
EPSF = "contracts/schemas/v6/astrocs.v6.effective-psf.v1.schema.json"
DICT = "contracts/data/v6_data_dictionary_v1.json"
VOCAB = "contracts/data/v6_weight_vocabulary_v1.json"
MIG = "contracts/data/v6_migration_map_v1.json"
EX_PSFSW = "contracts/data/examples/v6/psfsw.example.json"
EX_PROV = "contracts/data/examples/v6/provenance.example.json"
