...
- 任务: `P1-INTEGRATE-001`（Wave 7），write_scope = `lib/phase1/`、`lib/phase1_session/`、`tests/integration/v6_p1/`
...
| `tests/integration/v6_p1/README.md`、`tests/integration/v6_p1/EVIDENCE.md` | 说明与证据 |
...
3. **构建面欠账（AR-033 / W9）**：`astrocs_v6_phase1_product` 直接把 Wave 5 源编入
   静态库（与 `tests/unit/v6_*` 各自编译同源）。W9 将新生产源接入生产库时，请
