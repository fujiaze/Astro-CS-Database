# tests/system/v6_runtime — RUNTIME-CI-001 运行面系统测试

本目录是 V6 并行工程包 **RUNTIME-CI-001（Wave 9）** 的系统级收口测试。write_scope =
tests/system/v6_runtime/；根/公共 CMakeLists 注册由控制器在 W9 之后以独立集成提交
...
## 构建与运行（自包含）
    ...
    cmake -S tests/system/v6_runtime -B run/v6/RUNTIME-CI-001/build -DCMAKE_BUILD_TYPE=Release
