 ...
 *   eng/contracts/config/module_lifecycle_contract.schema.json（同一冻结语义的双形态,
 *   一致性测试见 eng/tests/abi/test_abi002_lifecycle.py）。头文件与 schema 必须同步修改。
 *
 ...
 * 转移表（与 eng/contracts/config/module_lifecycle_contract.schema.json
 * transitions[] 完全一致, 一致性由 eng/tests/abi/test_abi002_lifecycle.py 校验）:
...
/* host/loader 侧契约自检（ABI-002 冻结语义; 参考实现见 eng/tests/abi/abi002_lifecycle_probe.c;
