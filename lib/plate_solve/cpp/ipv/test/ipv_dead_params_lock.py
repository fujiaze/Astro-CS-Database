...
背景 (已实证):
  生产解算路径 phase1 run -> p1_op_wcs (lib/core/src/module_adapters.cpp:2100)
...
# HERE = lib/plate_solve/cpp/ipv/test
...
def main(argv=None):
    ...
    if errors:
        ...
        print("   lib/plate_solve/cpp/ipv/test/ipv_dead_params_manifest.json")
