 ...
 *
 * 对齐先例: lib/algorithms/calibration/include/astrocs/calibration/types.h (P1-CAL-IMPL,
 * commit adf820ac) / lib/algorithms/drizzle/include/astrocs/drizzle/types.h
 * (P1-DRZ-IMPL, commit 2c065ace) / lib/infrastructure/gaia_xpsd_client (CAT-GAIA-IMPL,
 * commit babe752d)。
 *
...
#define ASTROCS_COS_VERSION      "0.1.0-alpha.1"
