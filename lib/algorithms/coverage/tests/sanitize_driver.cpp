// lib/algorithms/coverage/tests/sanitize_driver.cpp — Phase2 G10 sanitizer 驱动（WSL）
//
// 用法（Linux/WSL，聚焦无 AIO 依赖的核心数值模块）：
// g++ -std=c++20 -g -O1 -fsanitize=address,undefined -fno-omit-frame-pointer \
// -I <repo>/lib/algorithms/coverage/include -I <nlohmann_include> \
// sanitize_driver.cpp ../src/upm.cpp \
// <repo>/lib/algorithms/shared/crypto/sha256.cpp \
