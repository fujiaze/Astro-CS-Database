...
- **目录**: `lib/algorithms/platesolve/cpp/ipv/`（独立于 V4.x 旧版代码）
...
```bash
cd lib/algorithms/platesolve/cpp/ipv
...
- `lib/algorithms/platesolve/python/rms_score.py`
- `lib/algorithms/platesolve/python/test_solver_vs_rms.py`
