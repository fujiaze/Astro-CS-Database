...
# astro_image_io 模块目录 (lib/infrastructure/aio/python)
_AIO_MODULE_DIR = os.path.normpath(
    os.path.join(_TEST_DIR, "..", "..", "..", "..", "astro_image_io", "python")
)
# astro_image_io.dll 所在目录 (lib/infrastructure/aio/)
_AIO_DLL_DIR = os.path.normpath(os.path.join(_AIO_MODULE_DIR, ".."))
# healpix_io.dll 所在目录 (lib/infrastructure/aio/healpix_db/healpix_io/)
