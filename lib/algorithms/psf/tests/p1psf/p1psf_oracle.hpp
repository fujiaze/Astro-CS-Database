...
// (lib/algorithms/psf/src/dpsf_psf.cpp) 无共享代码路径——生产代码用
...
//     由 lib/algorithms/star_detection/tests/p1star 与
//     lib/algorithms/psf/tests/p1psf/p1psf_prodpath_check.cpp 以显式常数引用。
