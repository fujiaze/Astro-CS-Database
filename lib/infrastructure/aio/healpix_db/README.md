...
```bash
# 1. 先构建 astro_image_io.dll (在 lib/infrastructure/aio/ 下)
cd lib/infrastructure/aio
powershell -ExecutionPolicy Bypass -File build.ps1

# 2. 构建 healpix_browser_qt (在 lib/infrastructure/hips_browser/healpix_browser_qt/ 下)
cd lib/infrastructure/hips_browser/healpix_browser_qt
...
或用启动脚本：
```bash
lib/infrastructure/hips_browser/healpix_browser_qt/run_healpix.bat <hiss或hcsd路径>
```
