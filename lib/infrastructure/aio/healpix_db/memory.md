...
- **路径**：`lib/infrastructure/aio/healpix_db/healpix_lod/`
...
- **路径**：`lib/infrastructure/aio/healpix_db/healpix_browser/`
...
- **原路径**：`lib/infrastructure/aio/healpix_db/healpix_browser_cpp/`
- **现位置**：`lib/infrastructure/hips_browser/healpix_browser_qt/archive/`（已移动）
...
- **原路径**：`lib/infrastructure/aio/healpix_db/healpix_browser_web/`
- **现位置**：`lib/infrastructure/hips_browser/healpix_browser_qt/archive/`（已移动）
...
- **路径**：`lib/infrastructure/aio/src/ahpx/`
...
#### 归档位置说明
- `healpix_browser_cpp/` 与 `healpix_browser_web/` 已移至 `lib/infrastructure/aio/healpix_db/archive/` 目录（2026-07-13 归档）
...
- 即：`healpix_drizzle` 与 `healpix_stack` 物理上位于 `lib/infrastructure/aio/healpix_db/` 下（在 `healpix_db/.gitignore` 中忽略），存在跨仓库编译依赖
...
- 路径从 ../healpix_io/ 变为 ../../astro_image_io/（跨 lib/infrastructure/aio/healpix_db/ 到 lib/infrastructure/aio/）
