...
timeout 1200 g++ $FLAGS -I"$ROOT/lib/algorithms/shared" \
    "$ROOT/lib/algorithms/shared/healpix/healpix_core.cpp" \
    "$ROOT/lib/algorithms/shared/healpix/tests/test_healpix_oracle.cpp" \
    -o healpix_oracle
...
gcc $FLAGS -I"$ROOT/lib/infrastructure/aio/third_party/cfitsio" \
    "$ROOT"/lib/infrastructure/aio/third_party/cfitsio/*.c -c > cfitsio_cc.log 2>&1 || true
rm -f f77_wrap1.o f77_wrap2.o f77_wrap3.o f77_wrap4.o drvrgsiftp.o windumpexts.o vmsieee.o
ls *.o >/dev/null
timeout 900 g++ $FLAGS -I"$ROOT/lib/infrastructure/aio/include" -I"$ROOT/lib/infrastructure/aio/src" \
    -I"$ROOT/lib/algorithms/shared" -I"$ROOT/lib/infrastructure/aio/third_party/cfitsio" \
...
timeout 900 g++ $FLAGS -I"$ROOT/lib/infrastructure/aio/include" -I"$ROOT/lib/infrastructure/aio/src" \
    ...
    "$ROOT/lib/infrastructure/aio/src/hips/aio_hips_reader.cpp" \
    "$ROOT/lib/algorithms/shared/healpix/healpix_core.cpp" \
    "$ROOT/lib/infrastructure/aio/tests/hips_robust_sanitize_driver.cpp" \
...
timeout 900 gcc $FLAGS -I"$ROOT/lib/infrastructure/gaia_xpsd_client/src" \
...
timeout 900 g++ $FLAGS -I"$ROOT/lib/algorithms/shared" \
    "$ROOT/lib/algorithms/shared/healpix/healpix_core.cpp" \
    "$ROOT/lib/algorithms/shared/healpix/tests/test_hips_tile_mapping.cpp" \
    -o hips_tile_mapping
