...
| 目录 | 用途 |
|---|---|
| `lib/infrastructure/aio/` | FITS/XISF/HISS 读写、pipeline |
| `lib/algorithms/calibration/` | 校准（bias/dark/flat/photometry apply） |
| `lib/data_pipeline/` | 数据管道 |
| `lib/algorithms/psf/` | 动态 PSF |
| `lib/infrastructure/gaia_xpsd_client/` | Gaia 客户端 |
| `lib/infrastructure/aio/healpix_db/` | HEALPix drizzle/stack/browser |
| `lib/infrastructure/pipeline/orchestrator/` | 调度器 |
| `lib/algorithms/photometry/` | 测光定标 |
| `lib/algorithms/platesolve/` | plate solving |
| `lib/algorithms/noise_snr/` | SNR 估计 |
| `lib/algorithms/star_detection/` | 星检测 |
...
| 路径 | 用途 |
|---|---|
| `lib/infrastructure/acr/` | ACR 全部源码、测试、工具、文档、CMake |
