// lib/infrastructure/acr/scheduler/dispatcher.cpp — Dispatcher 实现
...
struct Dispatcher::Impl {
    ...
    static std::uint64_t estimate_claim_peak_bytes(
        ...
        // 传输 staging（GPU）：输入已驻留时不重复计整帧 H2D，
        // 只计输出 D2H staging
