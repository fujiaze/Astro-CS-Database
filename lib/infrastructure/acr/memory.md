...
- **工具链问题与解决**：
  ...
  3. ctest "No tests found" 因顶层缺 `enable_testing()`。在 lib/infrastructure/acr/CMakeLists.txt 顶层加 enable_testing()（tests/CMakeLists.txt 也有，但顶层才生成根 CTestTestfile.cmake）
