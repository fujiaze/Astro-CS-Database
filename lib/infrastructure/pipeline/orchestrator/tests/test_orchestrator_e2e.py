...
本文件从 lib/infrastructure/aio/python/tests/test_orchestrator_e2e.py 迁移而来。
路径深度已更新（从 lib/infrastructure/pipeline/orchestrator/tests/ 出发仅需 3 级回到项目根目录）。
...
# 新位置: lib/infrastructure/pipeline/orchestrator/tests/ -> ../../.. = 项目根目录
