...
- 基线 SHA：**b32246c4**；当前 main：**12dcb8f41200919bcef9fa8330c6bc9a28a2abc1**；生成于复验前，**R 层开工前必须重跑刷新**。
- 基线后已进入 main 的改动（真源白名单内）：**47**；当前工作树脏：**15**；改动面合计 **61**，被审计档案点名 **60**，未点名 **1**。
...
| 改动文件 | 来源 | 被引 | 涉及条目 |
|---|---|---|---|
| CMakeLists.txt | CW | 404 | L01-011, L03-009, L03-008, L05-008, L07-025, L07-015, L08-006, L10-017 |
| ci/checks.json | CW | 300 | L06-015, L06-016, L11-016, L12-002, L16-010, L17-001, L23-006, L23-009 |
| docs/contracts/DATA_SEMANTICS.md | CW | 149 | L03-014, L18-017, L09-002, L03-017, L07-005, F00-04, F00-06, L02-002 |
| lib/core/src/module_adapters.cpp | CW | 135 | L05-004, L05-011, L11-011, L12-023, F00-04, L01-003, L01-010, L01-013 |
| tests/unit/CMakeLists.txt | C+W | 95 | L07-015, L10-017, F00-04, L01-013, L01-020, L02-005, L03-006, L03-008 |
| lib/astro_image_io/src/hips/aio_hips_writer.cpp | CW | 63 | M2b-L15 |
| cli/commands.cpp | CW | 62 | L05-004, L05-011, L12-023, L17-004, F00-03, L05-019, L09-008, L11-001 |
| docs/algorithms/DRIZZLE_GEOMETRY.md | CW | 47 | L20-005, L20-006, L04-003, L04-004, L04-005, L04-006, L04-009, L04-012 |
| docs/algorithms/HIPS_WRITER.md | CW | 44 | L03-002, L03-003, L03-011, L03-012, L03-013, L03-014, L03-018, L03-019 |
| docs/science/ASTROMETRY.md | W | 44 | L13-001 |
...
| docs/algorithms/PLATESOLVE.md | W | 37 |  |
| cli/CMakeLists.txt | W | 36 | L05-008, L25-010, L12-001 |
...
| docs/architecture/PRODUCTION_EXECUTION_INVENTORY.csv | CW | 13 |  |
| lib/plate_solve/cpp/ipv/include/ipv_types.h | W | 11 |  |
...
| lib/plate_solve/cpp/ipv/src/ipv_solver.cpp | W | 10 |  |
...
| docs/contracts/DATA_ARTIFACTS.md | CW | 6 |  |
| tests/unit/p1001_real_nodes_test.cpp | CW | 6 | L04-001, L05-013 |
| lib/plate_solve/cpp/ipv/src/ipv_select.cpp | W | 6 |  |
...
| lib/plate_solve/cpp/ipv/src/ipv_entry.cpp | W | 2 |  |
...
- tests/unit/ipv_platform_binding_test.cpp（工作树脏）
