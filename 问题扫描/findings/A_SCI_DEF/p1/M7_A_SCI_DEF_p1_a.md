...
- related L07-002、L07-009、L07-019、L02-008、M2a-H-2（ivar==0 单裁语义，A-11）、M7-A-111（L20-027 同族）；判定 **仍成立**；置信度 高
...
- related L08-001、L20-013（同一主题的枚举值数与保守向，另条）、M7-A-111、A-12；判定 **仍成立**；置信度 中高（表形状按 ALG 文本，未读 MC 测试数据）
...
- related M7-A-111、L08-001、M7-A-001；判定 **仍成立**（grep「乘k_corr=N_eff缩放」命中 :32）；置信度 高
