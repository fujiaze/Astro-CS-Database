...
| `DATA-P1-COS` | mapped | `eng/contracts/schemas/unified/signal.schema.json` | single_object | `docs/contracts/DATA_SEMANTICS.md:180（§10 ID 定义节，:182 状态 CONTRACT_READY）`<br>`docs/contracts/PUBLIC_API.md:152/:177`<br>`docs/modules/registry/astrocs.phase1.cosmetic.md:35（端口 cleaned）/:38-40（权威名说明）`<br>`docs/modules/calibration.md:12` |
