...
拟合退化（平坦星）/饱和；MAD 为 0；数值守卫见 lib/dynamic_psf/src/dpsf_psf.h 头锚点与 lib/dynamic_psf/src/dpsf_psf.cpp:45,71-74,89-91,114,169-170,326,333-344，契约见 docs/science/PSF.md。检测阈值：质心加权 `bkg+1.5·σ`（sdet_detector.cpp:215）、MAD→σ `1.4826`（sdet_image.cpp:493/snr 0.7316728 互补）、饱和 `median+0.7·dynrange`（star_detector.h SDetParams/sdet_api.cpp:700)。
