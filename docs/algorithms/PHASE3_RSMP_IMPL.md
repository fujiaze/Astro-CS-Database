...
| registry 生产 descriptor | astrocs.phase3.resample2（module_adapters.cpp:560 `p3_resample2_descriptor`，module_id 同名） | 实测 |
...
- descriptor 端口绑定（module_adapters.cpp:425-439）: 输入
