...
upstream: [SCI-P2-WR-001, ALG-P2-WR-001, API-P2-001]
downstream: [TEST-P2-WR-001]
---

# 模块 astrocs.phase2.write
...
| 端口 | DATA | 必/可 | 单位 | 坐标 |
|---|---|---|---|---|
| `integrated` | `DATA-P2-INT` | 必 | `UnitId::ADU` | `CoordinateFrame::PIXEL` |
| `mosaic` | `DATA-P2-RES` | 可 | `UnitId::ADU` | `CoordinateFrame::PIXEL` |
...
module_id=`astrocs.phase2.write`; execution_class=`io`;
...
`TEST-P2-WR-001` 对应测试(逐任务 TASK_RESULT 证据); 容差=验收冻结。

## 已知限制

见 docs/KNOWN_LIMITATIONS.md 与 `ALG-P2-WR-001` 合同边界。
