...
upstream: [SCI-P2-REJ-001, ALG-P2-REJ-001, API-P2-001]
...
module_id=`astrocs.phase2.reject`; execution_class=`cpu_heavy`;
...
`TEST-P2-REJ-001` 对应测试(逐任务 TASK_RESULT 证据); 容差=验收冻结。

## 已知限制

见 docs/KNOWN_LIMITATIONS.md 与 `ALG-P2-REJ-001` 合同边界。
