...
module_id=`astrocs.phase2.sample`; execution_class=`cpu_heavy`;
...
`TEST-P2-SMP-001` 对应测试(逐任务 TASK_RESULT 证据); 容差=验收冻结。

## 已知限制

见 docs/KNOWN_LIMITATIONS.md 与 `ALG-P2-SMP-001` 合同边界。
