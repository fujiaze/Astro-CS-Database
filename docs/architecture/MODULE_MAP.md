...
| CLI 平台单元 | `lib/infrastructure/cli/` | INSTALLED | `astrocs` | unit `PLATFORM-CLI`；`lib/infrastructure/cli/parser.cpp` kRules 12 条 phase 命令；`eng/tests/cli/test_cli001_vpi.py` 15/15 实测 |
