...
### 1.4 坐标契约 v2
- 文件：工程控制/evidence/P11-006/COORDINATE_CONVENTION_V2.md
- 内容：CRPIX统一、WCS+SIP管线内存块传递、A/B/C三层验证架构、B层硬Gate阈值、SIP序列化要求

### 1.5 provenance schema 扩展
- 文件：工程控制/contracts/wcs_authoritative_pairs.schema.json
...
- 坐标契约v2：工程控制/evidence/P11-006/COORDINATE_CONVENTION_V2.md
...
- schema：工程控制/contracts/wcs_authoritative_pairs.schema.json
